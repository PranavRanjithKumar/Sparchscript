...
<div class="row padding">
   <div class="col-md-6">
     <div class="card text-center">
       <img class="card-img-top" src="{{ asset('img/avatars/siva.jpg') }}">
       <div class="card-body">
   ...
   <div class="col-md-6">
     <div class="card text-center">
       <img class="card-img-top" src="{{ asset('img/avatars/pranav.jpg') }}">
       <div class="card-body">
         <h4>Pranav R R</h4>
       </div>
     </div>
...
<div class="row padding">
   <div class="col-md-6">
     <div class="card text-center">
       <img class="card-img-top" src="{{ asset('img/avatars/bharath.jpg') }}">
       <div class="card-body">
   ...
   <div class="col-md-6">
     <div class="card text-center">
       <img class="card-img-top" src="{{ asset('img/avatars/prasanth.jpg') }}">
       <div class="card-body">
         <h4>Prasanth P</h4>
       </div>
     </div>
...
<div class="row padding">
   <div class="col-md-6">
     <div class="card text-center">
       <img class="card-img-top" src="{{ asset('img/avatars/kamalesh.jpg') }}">
       <div class="card-body">
         <h4>Kamalesh E</h4>
       </div>
     </div>
   ...
   <div class="col-md-6">
     <div class="card text-center">
       <img class="card-img-top" src="{{ asset('img/avatars/maharajan.jpg') }}">
       <div class="card-body">
         <h4>Maharajan M</h4>
       </div>
     </div>
